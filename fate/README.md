...
速度为零，加速度不一定为零；加速度为零，速度可以不为零；速度大，加速度不一定大；加速度大，速度不一定大。



速度是描述物体运动快慢的物理量。
而加速度是描述速度变化快慢（速度变化率）的物理量，加速度不能反应物体运动的快与慢。加速度=速度变化量/时间。


初速度。末速度。时间。速度变化量。加速度。


读书就是一种速度为零，加速度不为零的事情。


一毕业就有5000，从-1500到5000，速度变化量很大，但加速度会怎么样呢。
初速度，
...
上大学和不上大学有什么区别。不学基本功和学习基本功有什么区别。加速度不一样。
