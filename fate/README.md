...
让我很迷惑，百思不得其解，但让我受益至今。一推概念、公式写上去，现在你同样有一些不解，不急。

比如一名大学生一毕业就有7000块，即使初始速度为负（父母给的生活费），初始加速度是大的，大部分能拿到平均工资以上。但随着时间的推移，选择对加速度产生了影响，有的工作是日复一日的重复，没有成长和进步，加速度几乎为零，甚至加速度为负（工资增长小于通货膨胀率）。而有的选择做好了，选好了城市、行业、职位、个人的终身学习的习惯都会大大增加加速度。

在理想环境下，一滴水滴从万米高空落下，能在大地上砸出一个大洞，地球引力造成向下的恒定的加速度g，当达到地表的时候有巨大的速度（能量）。加速度为零，但速度不一定为零，匀速运动的加速度为零。

飞机之所以能飞起来，是因为加速度大，能够瞬间摆脱地心引力，速度快是表象，加速度快才是本质。飞机能在20-30s内，把速度瞬间达到250-350㎞/h。。跑车的推背感，就是加速度。猛踩油门是改变加速度。 

毕业都是3500上大学和不上大学有什么区别。不学基本功和苦练基本功有什么区别。

亚伯拉罕·林肯说，如果我有八小时的时间砍一棵树，我会花费前六小时磨利自己的斧子。这就是速度和加速度思维。
学习学习的方法就是加速度思维。
苦练基本功就是加速度思维。
养成习惯是加速度思维。
...
加速度不一样，人生很长，加速度努力，才是真的努力。所谓磨刀不误砍柴工，魔石不误磨刀工。

![](images/020_Image_1.jpg)

匀速圆周运动的向心加速度总是指向圆心，即不改变速度的大小只是不断地改变着速度的方向。匀速圆周运动也不是匀变速运动，向心加速度的方向也在不断改变，但永远指向圆心且大小不变。

加速度和速度都是矢量，不仅有大小，还有方向。做正确的事情，速度才有意义，不然只能用早死早超生来安慰自己。

加速度也是有大小，也是有方向的。养成了一些坏习惯、做出了一些不好的习惯，都是阻碍速度的加速度。让你快速拉回到谷底。
...
过去100年里道琼斯指数增长曲线，世界人口增长曲线。在知识、财富、国家GDP等很多地方都是如此的曲线。

再看一下复利公式。`S = P(I + i)**n，其中以符号I代表利息，P代表本金，n代表期数，i代表利率，S代表本利和。不仅仅是钱可以用于投资，还有你的时间，越早越好。

我们明天能感觉到时间的加速度，小学六年是如此的漫长，然后是初中，高中，大学四年一晃而过，而疫情五年，仿佛就在眼前。时间随着年龄加速度越来越快。

每一天的时间消逝速度是不变的，滴答滴答地消耗没的，但因为感受的原因，在我们的大脑中时间消逝的加速度是不同的，大学毕业>大学>高中>初中>小学>幼儿时期。小时候的时光总是感觉消磨不完，总是盼望着明天。





大学做廉价劳动力，每天拿3000-4000的工资，速度是有的，但我们忽略了加速度的积累，大学应该读书、交朋友、感受生命、树立价值观，多做一些积累加速度的事情。这是我从《稀缺》这本书上看到的对我极为有用的结论：“既然决定上大学了，就代表你选择了一种投资。这四年，你可以更加努力地让自己变得值钱，而不是在最应该学习的年纪里，选择赚钱。现在拼了命赚钱，以后可能会没钱；现在拼了命输入，以后才有更好的收入。”
...
惯性和只有质量有关，
速度的变化量Δv与发生这一变化所用时间Δt的比值。

a#f/m。消费就是m，不管是房贷、车贷、昂贵的提前消费。

厚积薄发，就是后面积累了加速度。
加速度与速度无必然联系，加速度很大时，速度可以很小；速度很大时，加速度也可以很小。例如：炮弹在发射的瞬间，速度为0，加速度非常大；以高速直线匀速行驶的赛车，速度很大，但是由于是匀速行驶，速度的变化量是零，因此它的加速度为零。

学习底层的原理，打好基本功，都是在积攒加速度，改变的加速度。底层原理能演化出一个又一个的方法论。思考本质的东西，《教父》里有一句经典的台词：《教父》“花半秒钟就看透事物本质的人，和花一辈子都看不清事物本质的人，注定是截然不同的命运。”

体力拉不开加速度。不是线性加速，而是弹射模式。是要在某一阶段长时间的蓄力，然后到达某一个临界点，然后突然爆发，一年顶别人 100 年。而弹射需要什么，需要思考判断，需要明白规则，需要抓住风口，才能找到一条对手寥寥无几的赛道，才在能在某个时间点产生暴击，十倍百倍甩开别人。
