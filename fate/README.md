...
时间是我们唯一可以利用的资源。把时间放在游戏上，你的游戏段位就会提高。时间不可以保存等以后在利用，时间不可能加速也不可以减速，时间只能被利用，利用在游戏上、睡觉上。

你要认真选择时间的时间利用的事情，分好权重，优先的事情，按重要性利用。权重就是价值观，
...
时间更具体点来说，你上班了，时间可以用在上班上，但你的注意力可以不在工作上。就像学生一样，来上课，时间滴答滴答地走着，而它的思绪已经在校外生活上。
