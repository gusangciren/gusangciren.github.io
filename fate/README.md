...
现代文明中的伟大成就都是在过去200年里实现的。从1922年~2022年，在过去100年里，我们实现了现代文明中的绝大部分成就。在1922年之前的100年里，我们也实现了现代文明中的许多成就，在过去200年之前的几千年里，人类社会基本上一成不变。古代人的生活环境非常恶劣，寿命很短，生活很单调。在1922年之前的100年里人们发明了蒸汽机。蒸汽船铁路改进了农业技术，改进了排水管道，在1922年之后的一百年里人民发达了，覆盖广泛的电网、现代医药、汽车、飞机、电影、空调。人类的福祉实现了巨大的进步。（查理·芒格）
...
真理就像高中时候的，求三视图的原图形。你只有看到了每一个视角之下的情况，再加以思考，才可能发现得到真正的原图形。一个人，既要知道在高山之巅向下俯视的世界是什么样子，也要知道在万丈深渊向上仰望的世界是什么样子。
...
魔术是怎么实现如此神奇？魔术就是吸引我们的注意力，在我们不注意的地方，做一些动作，让我们觉得magical。
...
成功的人本来就很少，其次，有些人就是反复成功 —— 王兴、张一鸣、俞敏洪、李笑来，一定有一些可学习的地方。
...
>（1）交易效率：为了达成交易也付出的成本和收益。价值提高了，交易成本低了都是一种效率的提升。
...
>（2）生产效率：直接的收益和直接的成本之比。

什么是生产率？生产效率取决于很多因素，比如知识、科技、工具、机器、工具、方法、资金、资源渠道......等。过去农民靠自己双手种出300斤大米，但是随着科技发展一个农民种出千把斤的大米是没有问题的，这个就是生产效率。

生产效率是其直接的成本降低或收益提高，以时间单位说提高效率也是正确的。
...
这是作为跟随者的风口判断方法。
这是一种追随者视角去分析的。就好像你不是要创业开一家公司，也是你要找到一个公司然后投资于它。
...
马云说:人人都在抱怨的问题，你把他解决了，这就是机会。

你要成为一个先行者、创作者、价值给予者，你要发现问题并去解决。
...
危机，危险和机遇并存。很多伟大的公司和巨大的投资机会都是在经济危机中产生的。“百年未有之大变局”，中国不再是以前的中国，世界不是以前的世界。
危机危机，危机的另一面就是机会。危机，危险中包含着机遇，机遇中包含着危险。
风险从现在和未来的两个时间维度去解释。
只有变化中，才有好的机会。所谓乱世出英雄。机会偏爱

创业就是发现一类人的需求，而刚好你能解决问题，或者更好地解决问题。
...
GDP=产品+服务=消费+投资+出口=劳动时间+效率。人口少了，劳动时间少了，经济学里面所有的成本都是人力成本。
...
人口革命，表现为少子化和长寿化交互演化的人口老龄化；从社会哲学意义上说，就是社会形态的革命，也就是人类社会逐步迈入老龄社会，进入普遍长寿的新时代。这不仅会改变经济发展的方式，也将彻底改变传统。由于低生育率和高预期寿命两种因素的叠加影响，世界人口正在逐渐呈现老龄化的趋势。

人口老龄化和低生育率的国家，例如日本、韩国、中国、德国、意大利和西班牙。过去互联网上的很多商业模式都是copy的啊，马斯克直接说：收购twer,copy wechat 。
...
如何研究新事物 —— 你能为其做什么，然后根据数据和事实做判断。

iPhone来了，充电宝、数据线、APP等。

移动互联网的机会。需要且稀缺的东西。

当新事物出现的时候，又是一个从头来过的供需安排。当新事物出现的时候，你需要快速学习的能力，提供解决方法，抓住机会。

如何研究新事物。

**通过时间差制作稀缺优势**。红利是供需关系的短暂失衡。
...
刚开始平台上没什么内容，你能成为第一个供给者，你就受到平台的照顾和扶持。当内容供给大于内容消费时，流量就会很贵。供不应求、供需平衡、供大于求。然后打破重来，另一个平台崛起，一直都是如此。这就是周期。
...
把劳动力作为商品卖给资本家，因为资本家承担了风险，所获得的工资一定是低于实际创造的价值。这就是时薪、月薪、年薪、股东等人的区别。
...
如何一件事情任何都能够轻松地解决，那么这件事情并不能够给你带来竞争优势。
...
北京这个城市带来的无形资产，比如各种博物馆、画展，众多对外交流的机会，以及优秀人才汇聚的环境，根本没有办法被计算进去。大城市能够提高你的见识，让你在竞争的环境中“被动优秀”。
...
**地点决定你遇到什么样的人**，人又会决定养成什么样的习惯，逐渐影响你的世界观、价值观、思维等。“你是你周围六个人的平均值”。
...
创新和自由市场都是由人这个要素构建的，因此，看一个城市是否有发展看是否人口流入，尤其是年轻人是否有大量流入和定居。
...
发展好的城市都是交易中心，发达的大城市几乎都是交通枢纽点，这就是交易成本的优势。“十四五”要发展城市群，继续发展城市，并完善城际轨道，建设“一小时通勤”的都市圈。交通网络促进商业贸易的作用，这也是一个城市是否发达的指标。
...
我再做一个违背祖宗的决定：你还可以多听听风险投资的各种观点，然后自己独立分析。风险投资是干什么的，可以点击这个链接 --- [百度百科](https://baike.baidu.com/item/%E5%88%9B%E4%B8%9A%E6%8A%95%E8%B5%84/548179)
...
在做选择时候，还是得回答，你想要怎样的人生。我这里默认是做出改变、改变命运，安于现状。
...
## （四）
### 稳定性和确定性
只有稳定不变的环境和事情，才能让我们的认知保持一致，才会感觉良好。

如果外围环境不稳定，不稳定意味着未知和变化。

假设有一个森林，

大脑希望：大脑希望未来永远不变，减少模糊和不确定。
未知带来恐惧。
未知不可能消除，人生充满未知，恐惧一直存在。

过去的狩猎文明环境是不变的，几千年也看不到大变化。

如今哪有决定的确定性，一切都是不确定的。

再看一些数据。
改革开放到现在（2023）也就45年；河南大饥荒；2007年1月9日，苹果公司时任CEO史蒂夫·乔布斯在旧金山马士孔尼会展中心举行的Macworld大会上正式发布iPhone。有一个记录片，也有书籍。激荡三十年。可以看看2000的中国是什么样子。那些悲观者，眼里没有“光”，对生活没有希望憧憬的人，他们从来不读历史，不了解历史。
...
选择少有人走的路，初极狭才通人，豁然开朗。做难事，必有所得，走难路意味着和你竞争的人很少。可以靠努力稀缺，但稀缺更是一种选择，好书读好书的人是少数人做，坚持做一件事情的人是少数人做难而正确的人是少数人。做对选择也是少数人。读好书的人是少数人，持续读好书的人更是少数人。
